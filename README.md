...
### config/support-ui.php

The file `config/support-ui.php`  should be renamed to to something more useful, like `config/my-package.php`. This is the configuration file that Laravel will publish into it's `config` directory.
...
In the `handleConfigs()` method, the "support-ui" references should be changed to the name you chose up above (in the `config/support-ui.php` instructions).
